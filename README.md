...
- [Icecoder](http://icecoder.net/downloads) [<img title="Open Source" width="16" src="https://cdn.jsdelivr.net/npm/simple-icons@1.2.7/icons/github.svg" />](https://github.com/icecode/icecode) <img title="Self Hosted" width="16" src="https://cdn.jsdelivr.net/npm/simple-icons@1.2.7/icons/docker.svg" /> - A browser based code editor, allowing to code directly within the web browser, online or offline. Built-in terminal.
